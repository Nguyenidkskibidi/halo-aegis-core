...
echo "[1/4] Running ASan & UBSan Memory Safety Checks..."
...
echo ""
echo "[2/4] Compiling Embedded Release Binary & Verifying < 40 KB Flash Footprint..."
...
echo ""
echo "[3/4] Executing Real-Time Embedded Flight Simulation (0.00% Collision Gate)..."
./halo_flight_release
rm -f halo_flight_release
echo ">>> Dynamic Flight Collision Gate: PASSED (0.00% Collisions)"

echo ""
echo "[4/4] Running Sub-Microsecond Hardware Maximization Suite (-O3 -flto)..."
